"""오프라인 재실행 — 새 판정 없이, 기존 로그의 *판정된 후보 합집합*을
여러 점수식으로 재랭킹해 top-k 적중률을 비교한다.

한계: (유사도, 활성도)만 쓰는 식만 재현 가능(밴드패스는 풀 분포 필요, 로그엔 top-5뿐).
합집합은 '그때 보여준 후보'라 잠재 적중은 알 수 없고, 표본이 작으면 경향만.
"""
